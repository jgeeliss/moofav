...
Voor het vak **Advanced Web** ga je een interactieve single-page webapplicatie bouwen die gebruik maakt van een API naar keuze. De applicatie moet gebruikers in staat stellen om:

- Data te verkennen
- Te filteren
- Te sorteren
- Op te slaan in persoonlijke collecties (favorieten)
