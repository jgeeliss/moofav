...
- Arrow functions
    ...
    - [src/ui/filters.js:8-13](src/ui/filters.js#L8-L13) (setupThemeToggle: arrow function in addEventListener)
    - [src/ui/ui.js:125](src/ui/ui.js#L125) (populateGenreOptions: (genre) => {} in forEach)
    - [src/ui/movieRenderer.js:17](src/ui/movieRenderer.js#L17) (renderMovies: (movie) => {} in map)
    - [src/ui/movieRenderer.js:29](src/ui/movieRenderer.js#L29) (renderMovies: (id) => {} in map)
    - [src/data/moviesApi.js:91](src/data/moviesApi.js#L91) (fetchMoviesByIds: (id) => {} in map voor favorites)
    - [src/ui/scrolling.js:10](src/ui/scrolling.js#L10) (setupInfiniteScroll: (morePagesToLoad) => {} in .then())
- Conditional (ternary) operator (moderne if..else)
    - [src/ui/i18n.js:46](src/ui/i18n.js#L46) (setupLanguageToggle: ternary in language toggle)
    - [src/ui/filters.js:8-9](src/ui/filters.js#L8-L9) (setupThemeToggle: ternary voor isLight check en localStorage)
    - [src/ui/filters.js:72](src/ui/filters.js#L72) (setupFavoritesToggle: ternary voor favorites icon)
    - [src/data/favorites.js:5](src/data/favorites.js#L5) (getFavorites: ternary met fallback)
...
- Callback functions
    - [src/ui/i18n.js:46-52](src/ui/i18n.js#L46-L52) (setupLanguageToggle: callback in addEventListener)
    - [src/ui/filters.js:8-13](src/ui/filters.js#L8-L13) (setupThemeToggle: callback in addEventListener)
    - [src/ui/filters.js:117-151](src/ui/filters.js#L117-L151) (setupSearchAndFilterListeners: callbacks op input/select listeners)
    - [src/ui/moviePopup.js:17-24](src/ui/moviePopup.js#L17-L24) (showMoviePopup: onclick callbacks op buttons)
...
- Promises
    ...
    - [src/ui/scrolling.js:10-16](src/ui/scrolling.js#L10-L16) (setupInfiniteScroll: Promise.resolve en .then/.finally rond infinite scroll)
- Async & Await
...
- Fetch om data op te halen
    ...
    - [src/data/moviesApi.js:56-82](src/data/moviesApi.js#L56-L82) (fetchMovies: async API chain)
